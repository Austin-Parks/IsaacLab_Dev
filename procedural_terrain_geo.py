...
#FlatPatchSamplingCfg, TerrainImporter, TerrainImporterCfg
...
chunk_sz = 364.0 * 8.245521833
terrain_size = (chunk_sz, chunk_sz)
h_scale = 8.245521833
v_scale = 0.05
MY_TERRAIN_CFG = terrain.TerrainGeneratorCfg(
    ...
    sub_terrains={
        "hf_terrain_0": HfGeographicTerrainCfg(
            ...
            dem_tif_file="in/Tile_0_DEM_MERGED.tif",
            tci_tif_file="in/Tile_0_TCI_MERGED.tif",
            #dem_rows=364,
            #dem_cols=364,
            #no_data_val=0.0
        ),
...
def main():
    ...
    # Set main camera
    sim.set_camera_view(eye=[2000.0, 2000.0, 670.0], target=[0.0, 0.0, 420.0])
    # design scene
